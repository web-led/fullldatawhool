...
gameOn.addEventListener("click", () => {
    ...
    if (clickCount > 3) {
        ...
        <button style='background:#000;'> <a  style='color:white;'href='https://qed.adsleadone.fun/?utm_medium=a77b9dc7baec6899838ba8dd7558fe3db923211f&utm_campaign=target_DZ_c73bc53glaaaa'>مبروك كسبت معانا</a></button>
        `;
    }
